    ...
    function initSwipe() {
        ...
        document.addEventListener('touchend', function(e) {
            ...
            if (target.tagName === 'INPUT' || target.tagName === 'TEXTAREA' ||
                ...
                target.tagName === 'A' ||
                target.closest('.dsm-cell') || target.closest('.cell') ||
                target.closest('.option-label') || target.closest('.radio-option') ||
                target.closest('.nav-btn') || target.closest('.speaker-notes') ||
                target.closest('.scenario-card') || target.closest('.pattern-btn') ||
                target.closest('.flaw-marker') || target.closest('.field-btn') ||
                target.closest('.step-card') || target.closest('.sort-card') ||
                target.closest('.up-btn') || target.closest('.down-btn')) {
                return;
            }
